...
var resultsCon = document.querySelector("#results-container");
var citySrchEl = document.querySelector("#city-search"); 
var alertEl = document.querySelector("#alert");
var historyCon = document.querySelector("#city-history");
var cityHistoryBtn = document.querySelector("#city-history");
var infoConEl = document.querySelector("#info-container");
var forecastRow = document.querySelector("#forecast-row");

var formSubHandler = function(event) {
  event.preventDefault();

  var userCity = citySrchEl.value.trim();
...
var getForecast = function(data, cityName) {
  ...
  fetch(apiUrl)
      .then(function(response) {
        if (response.ok) {
          response.json().then(function(data) {
            disForecast(data, cityName)
          })
        }
      })
}

var disForecast = function(weatherData, cityName) {
...
getHistory();
srchBtn.addEventListener("click", formSubHandler);
